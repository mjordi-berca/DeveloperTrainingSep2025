namespace Terrasoft.Core.Process
{
	...
	public class UsrCalcAverageTicketPriceProcessMethodsWrapper : ProcessModel
	{
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			var esq = new EntitySchemaQuery(UserConnection.EntitySchemaManager, "UsrYacht2");
			var passengersCountColumn = esq.AddColumn("UsrPassengersNumber");  // SELECT UsrPassengersNumber as UsrPassengersNumber, UsrPricePerDay as UsrPricePerDay FROM UsrYacht WHERE ...
			var priceColumn = esq.AddColumn("UsrPricePerDay");
